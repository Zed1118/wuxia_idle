...
void main() {
  testWidgets(
    'passed fresh-save stages record four independent real-keyboard policies without requiring wins',
    (tester) async {
      final preparedDirectory =
          Platform.environment['P2_ONBOARDING_CHECKPOINT_DIR'];
      final checkpoints = preparedDirectory == null
          ? (await tester.runAsync(
              () => Directory.systemTemp.createTemp('onboarding_checkpoints_'),
            ))!
