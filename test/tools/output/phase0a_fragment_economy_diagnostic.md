...
| 单位 | 均值 | P50 | P90 | P95 | 100 场未集齐率 |
|---|---:|---:|---:|---:|---:|
| `rounds_across_all_mapped_bosses`（max） | 37.52778 | 36.0 | 50.0 | 54.0 | 0.00002 |
| `total_boss_clears`（sum） | 124.94778 | 124.0 | 154.0 | 164.0 | 0.86781 |
