...
void main() {
  ...
  test('balance simulation · 45 mainline × $_seedsPerStage seeds', () async {
    final mainlines =
    ...
    expect(
      ...
      reason: 'Demo §8.4 15-20 主线 + Ch4-6 P2 扩 + Ch7-9 二流三章 = 45 关',
    );
  ...
  // (×1.10^(c-1) + 御体/真气/识破等反制词条)。量化:winRate / 速通 ticks / 玩家掉血% /
