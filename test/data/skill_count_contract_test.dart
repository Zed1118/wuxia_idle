...
void main() {
  ...
  test('skills 210 + encounter skills 40 = merged SkillDef 250', () async {
    ...
    expect(genericIds, hasLength(210));
    ...
    expect(mergedIds, hasLength(250));
    ...
    expect(gdd, contains('| 通用 / 战斗招式（skills.yaml） | 210 招 |'));
    expect(gdd, contains('| 奇遇专属武学领悟招式（encounter_skills.yaml） | 40 招 |'));
    expect(gdd, contains('| 招式总池（SkillDef） | 250 招（210 + 40） |'));
  });
}
