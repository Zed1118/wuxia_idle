...
void main() {
  ...
  testWidgets('渲染 child', (tester) async {
    await tester.pumpWidget(host(const LightPaperPanel(child: Text('卷宗'))));
  ...
  testWidgets('默认画墨边外框', (tester) async {
    await tester.pumpWidget(host(const LightPaperPanel(child: SizedBox())));
    final box = tester.widget<DecoratedBox>(
      find
          .descendant(
            of: find.byType(LightPaperPanel),
