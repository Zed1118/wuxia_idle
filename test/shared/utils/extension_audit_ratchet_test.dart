...
/// 详 docs/dispatch/reports/2026-08-06_K1_techdebt.md:142-160)。但审计是一次性的——
/// 新 extension 悄悄进来不会被任何人再看一眼。本棘轮把「extension 全集 =
/// 已审计 15 处」钉成契约:新增 extension(任何文件,含已白名单文件)即红,
/// 强制经过一次人工审计再更新本表白名单。
///
...
void main() {
  ...
  group('K2 · extension 审计棘轮', () {
    test('lib/ extension 声明全集 = K1 附录 A 已审计 15 处(新增即红待审计)', () {
      // K1 附录 A 实测 15/15(2026-08-07 派单方重扫零漂移;K2 本会话复扫逐值吻合)。
