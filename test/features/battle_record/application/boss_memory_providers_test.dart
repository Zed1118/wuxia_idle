...
void main() {
  ...
  group('bossCatalog', () {
    test('含全 Boss：主线 isBossStage(45 条) + 塔 6 层，共 51 条', () {
      ...
      // 总数
      expect(catalog, hasLength(51), reason: '主线 45 + 塔 6 = 51');
      ...
      expect(
        ...
        hasLength(45),
        reason:
            '主线 isBossStage=true 共 45 关(mainline 36 + innerDemon 7 + lightFoot 1 + massBattle 1)',
      );
