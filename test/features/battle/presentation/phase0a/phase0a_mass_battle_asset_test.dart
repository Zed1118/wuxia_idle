...
void main() {
  for (final stageType in [StageType.massBattle, StageType.lightFoot]) {
    test(
      'all production ${stageType.name} standees decode with clear borders',
      () async {
        ...
        debugPrint(jsonEncode({'${stageType.name}_asset_evidence': evidence}));
      },
    );
  }
}
