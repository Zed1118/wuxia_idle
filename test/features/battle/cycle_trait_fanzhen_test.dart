...
void main() {
  ...
  test('反震:玩家命中有 cycle_fanzhen 的敌人 → 攻击者收到 InternalInjurySlot', () {
    ...
    expect(
      playerAfter.internalInjury!.remainingTurns,
      n.cycleEvolution.traits.fanzhen.ticks,
      reason: 'remainingTurns 应等于 fanzhen.ticks',
    );
    expect(
      playerAfter.internalInjury!.damagePerTick,
  ...
  test('反震:敌人攻击玩家 → 不触发（反震只对来袭的玩家生效）', () {
    ...
    final enemy = _mkBC(charId: 11, teamSide: 1).copyWith(actionPoint: 1000);
  ...
  test('反震:从 numbers.cycleEvolution.traits.fanzhen 读取参数值', () {
    ...
    expect(
      ...
      200,
      reason:
          'numbers.yaml cycle_evolution.traits.fanzhen.damage_per_tick 应为 200',
    );
    expect(
      n.cycleEvolution.traits.fanzhen.ticks,
      3,
