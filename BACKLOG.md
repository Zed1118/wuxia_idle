...
| # | 项 | 域/性质 | 拍板点 |
|---|---|---|---|
| 3 | P2③ Boss 协同窗口 | 设计讨论 | 「敌方协同」新概念,先定范围再动(master spec §四)。**2026-08-05 拍板 A1=进设计讨论(xhigh)**,产出(范围 spec 或论证不做)落地后此行随结果销/转 |
...
- (暂无。「爬塔与支线终局适配」已于 2026-08-04 批 A(PR #115 塔 49 层 1:1 锚死)/批 B(PR #117 四支线周目境界段推进)/批 C(PR #118 八立绘+smoke)三批全收口进 main;详 PROGRESS 同日三条目 + `docs/spec/2026-08-01-tower-extension-design.md`。)
