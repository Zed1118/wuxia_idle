...
| ~~11~~ | 场景题字清查 **2026-08-07 夜批 C1 完成:20 张清除+返修,复检 20/20,待用户复检** | 设计拍板→已执行 | 拍板点=用户复检 C1 成果定谳。背景数据(下次拍板直接用,无需重扫):真范围=battle 5+cover 3+narrative_stage 逐张确认约 **16-20 张一次拍全**(08-05 范围订正),禁只清 battle+cover;受影响文件**全部**封闭在 7月2日 早期 MJ 产物,7月18日后 52 张零问题不增量;规则真出处 G5.1 针对「冒充可读文本」非一切字形痕迹,朱红印章是主动要的母题须与多字题字分拍;可见性实测 cover+16% scrim 下题字落 1280×720 可见带内(frontier 16 关右上大字最扎眼);证据 `build/visual_acceptance/zh_inscription_ruling_2026-07-25/` 6 张(gitignored) |
