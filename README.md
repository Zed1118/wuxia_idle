...
软红线：当前满 build calculator 探针约 5.8 万（暴击约 8.7 万）；旧 3v3 已退役诊断曾记录真实普攻约 13.5 万、大招约 21 万，仅作历史参考，不是当前守卫。Phase 0A 起手画像真实路径逐次守“不进百万”，满 build 真实 reducer 极值仍待补——**核心唯一线 = 不进百万级膨胀**。
