...
> 🔧 **2026-06-12 进行中(战斗/装备 UX 整合方案 · worktree `worktree-battle-ux-equip-chain` `c7e13426` · 9/12 待批三)**:桌面方案文档1 Phase 0 三路核实(几乎全真)→ 范围三分整合方案(`docs/superpowers/specs/2026-06-12-battle-ux-equip-chain-integration.md`),只产纯 UX 类(零数值/零产品方向);半手动战斗(类B)+ 文档2玩法进化(类C)留待拍板。**批一藏经阁 `0eb5889e`**:T4 换招去 tier/倍率开发味→阶位中文+伤害+可破招 / T5 出战7槽用途说明 / T6 武学库行直接装配(抽 candidatesForSlot+legalSlotsForSkill 单一真相源+选槽面板) / T7 残页来源派生(塔/主线章末→未知未明)。**批二装备链路 `c7e13426`**:T8 详情强化开锋入口前移 / T9 SegmentDivider 纯绘制去 ink_divider / T10 角色面板已穿装备快捷操作面板 / T11 仓库5维筛选 / T12 物料用途。闸门 1950 测/1 skip/analyze 0。**待批三**(战斗子系统 battle_screen):T1 指令台暴露 availableSkills 全槽+待发印[高风险视觉重构] / T2 蓄力危险条[底栏 highlight 已有,缺顶部危险条] / T3 战报3条;视觉项 T8/T10/T11/批三 合 main 前派 Codex 验收。
