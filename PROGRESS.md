...
- **T42** 爬塔层列表 UI + 进度展示 + main_menu「问鼎九霄」入口（tower_floor_list_screen / tower_floor_card 三态+Boss边框 / tower_providers 2 个 + 顶部进度卡 + 7 按钮顺序）
...
- **T42** 爬塔层列表 UI + main_menu 入口（当前）
- **T43** tower_entry_flow（普通层 / Boss 层差异化）
