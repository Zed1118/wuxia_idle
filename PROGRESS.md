...
**M4 PoC #46 美术 Stage 2 W1+W2+W3 第 1+2+3 批 28/28 完工 · 寻常货 4 件 + 像样货 5 件 + 好家伙+利器 5 件全过验收**(2026-05-20 续,主对话 opus xhigh ~125min)。W1 寻常货 8 张 + W2 像样货 10 张 + W3 好家伙+利器 10 张 全 1024×1024 PNG 规范命名于 `~/Desktop/MJ_Stage2_W{1,2,3}/`。**W3 平均 8.65/10 是 Stage 2 至今最好的一批**(W1 ~8.5 / W2 7.9),风格一致度 ~90% / 类型识别度 ~90% / 好家伙→利器精致度梯度可读 / 水墨克制守住 / 无失败品归档。**W2 两大教训成功补救**:① 玄花斧 long-haft 锁定 ✅(防钢刀偏短复发) ② 玄铁甲 hip-length lamellar ✅(防皮甲 vest 复发) ③ 链子鞭复用 W2 V5 通用链鞭模板 7.5/10 borderline 接受。**古玉佩 detail v1 玉佩缺失 → v2 修正 prompt 重抽 6/10 → 9.5/10** ⭐⭐⭐(本批 Stage 2 至今最佳)。**Stage 2 累计 28/~75 张(37%)**,Fast 实耗 W1+W2+W3 = ~75min(剩 ~12.5h 月配额够 W4-W6)。**补 memory 第 13 条**:`feedback_mj_wuxia_prompt_pitfalls` 加 detail 类 prompt 必须强化主体可见性(主体定位 token 前置 + `--no missing X, scenery only` + stylize 降至 200 + 具体场景+光源锚定)。**下波**:Stage 2 W4 第 4 批 重器 5 件 + 3 师徒角色立绘 = 13 张(~40min Fast,重器精致度 `notable, distinctive` 拐点,角色立绘走主角色 sref + sw 60-70)。详 `docs/handoff/art_poc_stage2_w{1,2,3}_closeout_2026-05-20.md`。
