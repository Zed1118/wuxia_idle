...
- **M2 优先续验**：已补两次黑风岭明确战败/重试/返回，合法新档首关未获胜；真实冷存档生产对照中，首关和黑风岭合计0/36胜，不能将高数值测试角色通关当作开局体验 PASS。简单血量/入场宽限候选均未解被测群战，未改生产数值；真人策略验证或重开冻结调优是下一阻塞。原档哈希及隔离档通关/奖励未误增，详 `docs/audit/phase2_m2_priority_acceptance_2026-09-05.md`。同 SHA Windows 构建 `33964735494` 已触发，尚待结果。
