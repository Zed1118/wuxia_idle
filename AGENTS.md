...
买断制、写实武侠挂机游戏(发布目标 Windows,开发/验收在 macOS)。Flutter Desktop,Phase 0A 单角色横版水墨 ARPG + 同核离线挂机；旧 3v3 只留历史记录，不是产品模式。当前阶段:**1.0 长线打磨期**(质量优先,不设上线时间压力 · 详 CLAUDE.md §7 / GDD §1)。
