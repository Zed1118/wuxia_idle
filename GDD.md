...
| 典故文案 | 50-80 段 |
| 主线剧情字数 | 3,000 ~ 5,000 字 |

> **节日 encounter 独立通道**（W16 GDD §12.4 落地 2026-05-16）：6 节日 encounter
> （春节/元宵/端午/七夕/中秋/重阳 各 1 条）走 `festivalRequired` 维度，全年仅
> 6 天概率窗口触发，**不挤占基础奇遇 20-30 池容量**。玩家年内能触发的基础池
> 仍是 20-30 上限，节日池为应景独立通道（GDD §12.4「节日活动：不影响数值」
> 的内容层落地）。
