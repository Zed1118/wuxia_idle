...
> **v1.54 变更**(2026-08-25 二阶段江湖地图声望第六地点纵切):“江湖恩怨”从主菜单平铺迁入江湖地图，继续使用第一章末关门槛并进入既有 `ReputationPanelScreen`；宗门 Hub 共享同一社交门槛，江湖商店保持原条件入口。这只关闭声望地点归位缺口；统一地点详情、U06/U14/M6/二阶段仍开放，不改 schema、YAML、调优、声望算法、奖励、经济或解锁。
>
