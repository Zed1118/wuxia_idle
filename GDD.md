...
>
> **版本**:v1.33
> **v1.33 变更**(2026-08-24 二阶段 G0 推荐方案拍板 · 设计合同收口):冻结主线 replay/连续 run、随行听剑对象与占用、心魔失败惩罚、生态分批审核边界，以及“断魂庄不开放前台可见 bot”的决议；七心魔 AI 与渐进解锁进入有安全默认的矩阵/迁移表流程；五项旧否继续不重开，失败原因仅放开事实展示；20 项调优只授权候选生成，未批准生产值。详 §12.4.2 与 decision registry。
