...
|------|------|
| **战斗掉落** | 所见即所得（敌人用什么掉什么） |
| **江湖商店** | 固定货架·固定标价·无刷新（P1 激活，售炼器材料磨剑石/心血结晶；守 §5.1 无每日刷新/限购/机缘定价，守 §5.5 银两离线=在线）。原「每日刷新+机缘定价」设计 2026-06-21 拍板废除。**P2 激活经验丹/秘籍用途**（2026-06-21）：经验丹 3 档加角色经验推境界（守升层锁），秘籍解锁对应秘传招（仅掉落不上货架，守 §5.7 江湖偶得绝学的磨砺感）；经验丹小/中上货架可买，大档/秘籍仅掉落 |
