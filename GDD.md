...
> **v1.56 变更**(2026-08-25 二阶段九霄塔统一地点详情首纵切):九霄塔地点先展示生产进度、下一层推荐境界、敌方生态、首通掉落/修为、真实当前掌门、亲战方式与预计占用，再经原闭关战斗门禁进入塔层列表。异常 fail closed 且无 CTA，登顶保留重打。该纵切不新增派遣、自动化、持久占用或 U14 参与规则，只关闭九霄塔地点详情首缺口；其余地点详情、U06/U14/M6/二阶段仍开放，不改 schema、YAML、调优、奖励、经济或解锁。
>
