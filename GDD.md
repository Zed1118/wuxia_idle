...
生产迁移进度（2026-08-25 最新切片）：G1 生产合同、G2 黑风岭纵切、第一章连续首通、权威持久结算及其中互动奇遇/Boss 招降的 U04 持久 FIFO 已验收；可见真人重打现已按实际参与者贯通生产 Host 与归属结算，但 `U01` 仍因听剑生产接线和 headless/扫荡等全模式一致性未闭环而不得标记完成。U05 四个一级入口均已经独立 READY：“继续江湖”直达当前首推关，“武学与行囊”“宗门”“江湖纪事”收拢原生产路由；资源、设置与退出已归入角落工具区，心魔只保留角色突破入口，本地排行榜已归位九霄塔且保持 Noop 同步。U06 已建立同卡片次级江湖地图入口，九霄塔、轻功试炼、守城试炼、断魂庄、百草岭远征与江湖恩怨已成为六个生产地点，均保持原准入和去向；声望地点复用第一章末关门槛与既有声望面板，宗门 Hub 仍消费同一社交门槛；江湖商店保持主菜单条件入口。统一地点详情、其他未迁移野外内容与 U14 仍开放。U04 不外推到塔/特殊模式全局队列；排行榜归位缺口已单独关闭，但本切片不晋升 U05 整体状态，U06、M2、M6、M3/M4 及其他里程碑仍开放；断魂庄仍不开放前台 bot 或代选奖励，本次不改声望算法、奖励、解锁、调优或其他业务规则。
