...
> **v1.48 变更**(2026-08-25 二阶段江湖地图九霄塔首地点纵切):“继续江湖”仍为直达当前关的一级主动作，江湖地图作为同卡片次级动作，不增加第五个一级入口。九霄塔从主菜单平铺迁为地图首个生产地点，原进度派生、战斗守卫与 `TowerFloorListScreen` 去向不变。这只关闭九霄塔首地点缺口；其他地点、统一地点详情、U06/U14/M6/二阶段仍开放，不改 schema、数值、概率、奖励、经济、解锁或叙事。
>
