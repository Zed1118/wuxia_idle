...
> **v1.43 变更**(2026-08-25 二阶段“武学与行囊”一级 Hub 纵切):主菜单原先散列的装备仓库、心法面板与藏经阁收拢为一个“武学与行囊”入口，内部复用既有招式配置、主修心法、装备和物品生产 Screen；装备/物品分别进入库存 Tab 0/1，招式/主修沿用 tutorial step 3 与 active roster 第一位角色，身份未决时 fail closed。这只关闭 U05 四个一级入口中的第二项，“宗门”“江湖纪事”、U05/M6 或二阶段仍开放；不改业务写入、schema、数值、概率、奖励、解锁或叙事。
>
