...
生产迁移进度（2026-08-24 最新切片）：G1 生产合同、G2 黑风岭纵切与第一章连续首通已验收；本次又将该五关的权威核心结算、同人同关崩溃恢复、已提交 receipt 去重与关间原子交接收入生产。`U01` 仍因听剑生产接线、replay/manual/auto/headless/扫荡参与者与结算一致性未闭环而不得标记完成；互动奇遇/招降仍缺 U04 持久待处理队列。U04、U05、M2、M6、M3/M4 及其他二阶段里程碑均仍开放；断魂庄仍不开放前台 bot 或代选奖励，本次不改奖励、解锁或调优值。
