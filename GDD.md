...
> - 实测锚:105 关首通 **Lv116**(累计 5604 经验);全内容参考路线 **Lv130**(由 `progression_release_budget_test` 维护,实测锚不入自动校验)
...
- 当前数值映射：1～15 层覆盖学徒三段，16～30 层覆盖三流·启蒙 / 入门 / 熟练；30 层为 Lv100 前的当前终局门槛。高阶塔敌人与掉落不从本入口提前发放。
