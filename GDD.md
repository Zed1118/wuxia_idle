...
> **v1.57 变更**(2026-08-25 二阶段主菜单“当前要事”精确角色路由纵切):闭关、伤势与突破摘要已绑定真实 active roster 角色，闭关并透传真实境界；点击前重新核验角色与当前闭关关联，异常 fail closed，不再猜测角色 1。摘要优先级、文案、上限、桃花岛/主线路由和业务规则不变。这只关闭当前要事角色路由缺口，U05/U06/U07/M6/二阶段仍开放，不改 schema、YAML、调优、奖励、经济或解锁。
>
