...
- **当前发布边界**为绝对境界层 10（三流·熟练，对应 Lv100）。达到边界后只停止进入第 11 层，经验仍无上限累加并显示“待开放”；旧档若已在 Lv101+，保持原境界、等级与经验，不做降级，只拦后续进层。
- 当前 30 关主线从 Lv1 出发的目标终局为 Lv35～50；当前主线、塔、轻功、群战、心魔、72h 闭关、24h 普通离线与三枚经验丹组成的参考路线目标终局为 Lv80～95。二流及以上境界、装备和心法定义继续保留，作为未来副本与玩法的成长空间，不要求玩家在当前主线升完。
