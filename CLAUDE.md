...
| 12 | 江湖商店折扣公式(Demo 不列)| ~~Demo 内容总量表(§7)未列江湖商店,1.0 版需要时再补~~ **P4 材料经济 P1 已激活 ✅**(2026-06-21):固定货架·固定标价·无刷新·售炼器材料(磨剑石/心血结晶),银两货币(InventoryItem `item_silver`/`ItemType.silver`)·掉落+闭关产出·不卖出。**无折扣公式**(原「机缘定价」拍板废除,贴 §5.1)。GDD §6.1 同步改写。详 spec `docs/spec/2026-06-21-p4-material-economy-design.md` |
