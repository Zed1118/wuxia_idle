...
class EquipmentStatDiffText {
  static const labelAttack = UiStrings.equipmentCompareAttack;
  static const labelHealth = UiStrings.equipmentCompareHealth;
  static const labelSpeed = UiStrings.equipmentCompareSpeed;
  static const labelEnhance = UiStrings.equipmentCompareEnhance;
  static const labelTier = UiStrings.equipmentCompareTier;
  static const labelResonance = UiStrings.equipmentCompareResonance;
  static const labelSchool = UiStrings.equipmentCompareSchool;
  static const labelHeritage = UiStrings.equipmentCompareHeritage;
  static const emptyForging = UiStrings.equipmentCompareEmptyForging;
  static const schoolNone = UiStrings.equipmentCompareSchoolNone;
  static const heritageYes = UiStrings.equipmentCompareHeritageYes;
  static const heritageNo = UiStrings.equipmentCompareHeritageNo;
}
...
EquipmentComparison equipmentFullDiff({
  ...
  final candAtk = CharacterDerivedStats.effectiveEquipmentAttack(
    candidate,
    numbers,
  );
  final candHp = CharacterDerivedStats.effectiveEquipmentHp(candidate, numbers);
  final candSpd = CharacterDerivedStats.effectiveEquipmentSpeed(
    candidate,
    numbers,
  );
  ...
  final categoryRows = [
    CategoryRow(
      ...
      currentText: current == null
          ? null
          : EnumL10n.equipmentTier(current.tier),
