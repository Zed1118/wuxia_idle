...
import '../../combat_shared/domain/hero_camera_data.dart' show HeroCameraData;
...
import '../application/tower_settlement.dart'
    show
        TowerSettlementDependencies,
        TowerCombatResolution,
        TowerVictorySettlement,
        persistTowerDropsInTxn;
import '../application/tower_settlement.dart' as settlement;

export '../application/tower_settlement.dart'
    show TowerCombatResolution, TowerVictorySettlement;
...
Future<TowerVictorySettlement> applyTowerVictorySettlement({
...
}) => settlement.applyTowerVictorySettlement(
  ...
  afterProgressInTxn: afterProgressInTxnForTest,
);
...
Future<TowerCombatResolution> applyTowerCombatResolution({
  ...
  DateTime? settlementAt,
}) => settlement.applyTowerCombatResolution(
  dependencies: _towerSettlementDependencies(ref),
  floor: floor,
