...
// 第 5 批 C/I 任务整体拆分完成 + W17 nightshift T03 删除 0-consumer
...
// - gameRepositoryProvider 删除(W17 T03,全仓 0 consumer,代码走
//   `GameRepository.instance` 单例)
//
// 最终态:基础设施层只装 isar 1 个真基础设施 provider,不反向 import features/。
// =========================================================================
