...
class UiStrings {
  ...
  // floor30 护法结界（Task 6）：结界生效中头像旁小标签 + hover 释义合一
  // （AvatarStatusTag 药丸展示短文案，同串兼作 gloss，与 statusSwordSongLabel
  // 等既有短状态标签用法一致）。破界瞬间走 UltimateCaptionOverlay 题字通道
  // （复用转阶段题字机制，不另起平行系统）。
  static const String guardianWardActive = '护法结界·刀枪不入';
