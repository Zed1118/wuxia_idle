...
> ⚠️ **2026-06-27 状态钉**：本路线图末次主修订 2026-06-02（v1.13 · ~99% · 1667 测）；项目 2026-06-11 起转「1.0 长线打磨期」（CLAUDE.md §7），P1–P5+ 内容周期 + P4 长期档案均已闭环。PVP 已于 2026-06-27 切除，不再属于 1.0 范围；**当前进度唯一源 = PROGRESS.md**，本文档作宏观规划历史参考。
...
| **P3 战斗形态扩展** | M10-M12 | §12.3 轻功对决 / 群战守城 / 门派事件 | M12 战斗形态 2 种全交付;PVP 已切除 |
...
- **已切除(2026-06-27)**:不保留玩家入口、路由、provider/service、占位 UI、玩法配置或 Supabase 扩展计划。
- 旧 `StageType.pvp` 与 `PvpRecord`/`PvpSnapshot` 仅作存档兼容忽略。
...
| §12.3 PVP(异步) | ❌ 已切除 | -- | 仅保旧档 schema 兼容 |
