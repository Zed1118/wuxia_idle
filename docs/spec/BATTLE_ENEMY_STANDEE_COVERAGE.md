...
### 批次 02：高复用敌人组（已完成·2026-07-17 全关卡双视口验收统一关闭）
...
- 已验收（2026-07-17 全关卡双视口验收统一关闭）：真实关卡整队的 1280×720 / 1440×900 体量、遮挡、色温与状态牌边界。

### 批次 03：早期主线专属覆盖（已完成·2026-07-17 全关卡双视口验收统一关闭）
...
- 已验收（2026-07-17 全关卡双视口验收统一关闭）：`stage_01_02`、`stage_01_03`、`stage_01_04` 与塔 2 / 3 / 8 层整队双视口。
...
### 批次 08：第二章长尾专属化（已完成·2026-07-17 全关卡双视口验收统一关闭）
...
- 已完成（2026-07-17 全关卡双视口验收统一关闭）：`stage_02_02` / `stage_02_03` / `stage_02_04` 的真实整队双视口验收。

### 批次 09：第三章长尾与 Boss 专属化（已完成·2026-07-17 全关卡双视口验收统一关闭）
...
- 已完成（2026-07-17 全关卡双视口验收统一关闭）：`stage_03_02` / `stage_03_03` / `stage_03_04` / `stage_03_05` 的真实整队双视口验收。

### 批次 10：轻功特殊玩法专属化（已完成·2026-07-17 全关卡双视口验收统一关闭）
...
- 已完成（2026-07-17 全关卡双视口验收统一关闭）：`stage_light_foot_01` 至 `05` 的真实整队双视口验收。

### 批次 11：群战特殊玩法专属化（已完成·2026-07-17 全关卡双视口验收统一关闭）
...
- 已完成（2026-07-17 全关卡双视口验收统一关闭）：`stage_mass_battle_01` 至 `05` 的真实整队双视口验收；共享资源专属化已在后续批次完成。

### 批次 12：爬塔 Boss 共享资源专属化（已完成·2026-07-17 全关卡双视口验收统一关闭）
...
- 已完成（2026-07-17 全关卡双视口验收统一关闭）：塔 5 / 10 / 15 / 25 的真实双视口验收。

### 批次 13：章节 Boss 共享资源专属化（已完成·2026-07-17 全关卡双视口验收统一关闭）
...
- 已完成（2026-07-17 全关卡双视口验收统一关闭）：章节 Boss 真实双视口验收；正式数据中已无仍复用他人立绘的 Boss。

### 批次 14：普通敌人共享资源专属化（已完成·2026-07-17 全关卡双视口验收统一关闭）
...
- 已完成（2026-07-17 全关卡双视口验收统一关闭）：真实关卡双视口验收与截图审计，不再新增角色立绘，除非验收发现明确风格或构图缺陷。

## 后续优先级

上述五项已于 2026-07-17 全部完成，正式台账转为维护态；后续仅在新增关卡或新增敌人时增量更新。

## 全关卡双视口验收结论（2026-07-17）

- 新增 `battle` 视觉验收套件，动态消费真实 `stages.yaml` / `towers.yaml`，覆盖 30 个主线关、30 个塔层、5 个轻功关、5 个群战关，共 70 个真实目标。
- 70 个目标均完成 1280×720 与 1440×900 实窗截图，共 140 张；140 份日志均包含 `VISUAL_ROUTE_READY` 与窗口 ID 捕获记录。
- 自动审计：截图数 140 / 140，日志数 140 / 140，尺寸全部符合 Retina 2× 输出（2560×1440 / 2880×1800），`VISUAL_ROUTE_ERROR`、Flutter overflow、exception、缺图均为 0。
- 逐图联系表与主线终章、塔 30、轻功 5、群战 5 代表帧复核通过：全身完整、敌我站位对称、脚底墨影落地、血条不压人物、技能牌无文字溢出。
- 审计发现并修复 Boss 立绘矩形金色 `BoxShadow` 造成的黄底方块；Boss 继续由立绘尺度、HUD 金框与战场墨云建立层级，修复后全套复拍无黄底残留。
- 本地证据目录：`build/visual_acceptance/battle/{1280x720,1440x900}/`；该目录为构建产物，不入 git。
