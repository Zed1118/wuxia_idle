...
- [~] **#4 出战编成/换人 UI(2026-07-14 已拍板:做,C 完整编成屏)**:三拍板=C 完整编成屏 / 纯编成不动成长(inactive 成长渠道留后续独立拍板,追赶补助仍 rejected)/ 并入 PR #36 观察①(心法主辅修选择流收窄版)。spec 见 `2026-07-14-team-lineup-screen-design.md`(取代 07-05 brief),**待实装批**(建议 opus xhigh,0.5-1 天)。
