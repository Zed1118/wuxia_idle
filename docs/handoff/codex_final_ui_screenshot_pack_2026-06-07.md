...
本轮处理 T9「最终截图包与 UI 验收」第一批 1280x720 核心截图。覆盖主菜单、战斗、胜利、角色、仓库、装备详情、心法、主线、爬塔、闭关。
...
总判: 第一批 1280x720 核心截图通过，可作为 review 包；暂不标记为最终 Steam 商品图。

| 项 | 结果 | 说明 |
|---|---|---|
| 1280x720 尺寸 | 通过 | 全部截图为 1280x720。 |
...
| 商品图适配 | 待二轮 | 胜利 preview 构图偏小，后续建议做全屏胜利候选图；还需补 1920x1080。 |
