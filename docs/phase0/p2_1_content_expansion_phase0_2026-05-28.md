...
| # | 决策点 | 候选 | 推荐 |
|---|---|---|---|
| Q1 | 装备扩充方案 | A(slot 变体) / B(纯堆叠) | **A** |
| Q2 | 心法扩充方案 | α(3 流派加深) / β(加第 4 流派) | **α** |
| Q3 | 相生扩充数量 | 10 / 12 / 15 | **12** |
| Q4 | 批次拆分 | 3 批(装备→心法→lore) / 4 批(装备→心法→lore→相生+测试) | **4 批** |
| Q5 | 美术策略 | 先 placeholder 后补 / 同步出图 | 先 placeholder |
| Q6 | 低阶心法技能数 | 全 3 招 / 低阶 2 招高阶 3 招 | **全 3 招**(一致) |
