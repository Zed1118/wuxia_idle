...
## spec Q&A 候选清单(5 项 · 起床拍板)

| Q | 主轴 | 方案 + 推荐 |
|---|---|---|
| Q1 | §12.1 + §12.2 合批 vs 拆批 | A 合批 6-8h 一次扩 / **B 拆批 ~4-6 + 6-8h**(声望先 · enmity 依赖声望初始化) |
| Q2 | NpcRelation schema 粒度 | A 全连接 N×N / **B 稀疏 NpcRelation{source,target,type,level}** / C 单向 enmity 只玩家→NPC |
| Q3 | 触发维度 | 杀关键 NPC -50 / 救助 +20 / 学敌对心法 -10 · **Demo 先 stage_boss + encounter 2 维(YAGNI)** |
| Q4 | NPC 反应影响 | A UI narrative 分支 / B 战斗 ±15-25% / **C A+B 全包**(沿 P3.1.B 体例) |
| Q5 | 声望分阶 | 沿 GDD §5.2 七阶节奏 · 学徒→武圣 7 阶解锁门派关系 · 行侠 ×0.7 / 行恶 ×1.3 enmity 乘子 |
