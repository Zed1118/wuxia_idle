...
**Files:**
- Create: `docs/suno_reward_treasure_sfx_prompts_2026-06-11.md`

> 素材生成是用户在 Suno 的动作;本 task 只产 prompt。动画 wiring 已用现有 reward.mp3 占位落地(Task 6),新素材到位后替换(零接线改动)。

- [ ] **Step 1: 写 prompt doc**(沿 `docs/suno_battlehit_blade_sfx_prompts_2026-06-11.md` 体例,目标:珍稀「获得宝物」质感,明确区别 victory 上扬。含 4 条 reward 候选 prompt,强调 wuxia 玉/磬/古琴泛音的「得宝」感而非「胜利」感,≤1.5s one-shot)。

- [ ] **Step 2: Commit**：

```bash
git add docs/suno_reward_treasure_sfx_prompts_2026-06-11.md
