...
- [x] **Step 1: Write the failing coverage parser tests**
...
- [x] **Step 2: Write the failing workflow contract tests**
...
- [x] **Step 1: Implement the pure parser**
...
- [x] **Step 2: Implement CLI I/O and exit behavior**
...
- [x] **Step 3: Add provisional versioned baseline**
...
- [x] **Step 1: Wire ratchet after coverage generation**
...
- [x] **Step 2: Add the Windows workflow**
...
- [x] **Step 3: Run workflow GREEN tests**
...
- [x] **Step 4: Commit workflow slice**
...
- [x] **Step 1: Generate fresh coverage**
...
- [x] **Step 2: Measure with the new parser**
...
- [x] **Step 3: Prove pass and prove failure**
...
- [x] **Step 4: Ensure coverage is untracked/ignored**
...
- [x] **Step 5: Commit measured baseline and recovery point**
