...
- 状态：已完成有时限只读定界；下一步先建立第四章生产合同 RED，再写 assignment、encounter 与 runtime binding。
- 阻塞项：第四章后四关仍由 legacy mapper 消费；真人桌面、平衡/手感、视觉、音频与 Windows 继续挂账；`stage_02_05` 高基础随从风险未处理。
