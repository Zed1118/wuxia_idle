...
- 状态：已完成，Mac 工程与动态实机目检通过。
- 最后完成：单角色三连战 live/headless、HP/真气/补给/阶段续传、历史多人回落、失败/恢复/奖励/门票事务均已接回；生产锁脉针 `qiDrain` 语义已补齐。
- 下一步：六人主观 Gate 与 Windows Gate 继续保持锁定；后续与旧入口拆除同批原子切换。
- 已跑验证：兼容分流 7/7、断魂庄全族 183/183、相关事务 59/59、全仓 analyze 0 issue、全量 5403/5403；五灰度 macOS debug build 成功；1280×720/1440×900 动态实机目检通过。
- 阻塞项：无。
