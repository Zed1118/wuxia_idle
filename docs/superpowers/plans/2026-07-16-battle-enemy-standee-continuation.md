...
- **状态**：进行中。
- **最后完成**：第二章三名长尾敌人已专属化并提交；第三章 `guntou_zhu` / `seng_huiyi` / `balian` / `huiyi` 已完成生成、抠图、alpha 技术检查和生产映射，覆盖提升至 49 / 79 种、90 / 120 次出场。
- **下一步**：运行第三章映射回归并提交小切片；补齐轻功与群战 30 名专属敌人，同时扩展真实冻结路由，最后集中跑第一至三章、低层塔和特殊玩法双视口验收。
